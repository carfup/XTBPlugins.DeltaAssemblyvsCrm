...
namespace Carfup.XTBPlugins.DeltaAssemblyvsCrm
{
	[Export(typeof(IXrmToolBoxPlugin)),
	   ExportMetadata("Name", "Delta Plugins : Local Assembly vs CRM"),
	   ExportMetadata("Description", "Find out if there is differences between your local and CRM assemblies"),
